...
In the STA representation, the field can similarily be altered by adding any (four)gradient to the potential.  For example with only electric sources
...
Should one of these conditions, say the potentials for the electric source case, be non-zero, then it is possible to make a potential transformation for which this condition is zero
